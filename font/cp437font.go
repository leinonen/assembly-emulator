...
// CP437Font contains the 8x16 bitmap font data for all 256 CP437 characters
// Each character is 16 bytes (16 rows × 8 pixels), 1 bit per pixel
// This is the authentic IBM VGA ROM font used in text mode and CP437 encoding
var CP437Font = [256][16]byte{
	// 0x00 - NULL (empty)
	...
	// 0x90 - É
	{0x18, 0x30, 0x60, 0x00, 0xFE, 0x66, 0x62, 0x68, 0x78, 0x68, 0x62, 0xFE, 0x00, 0x00, 0x00, 0x00},
	// 0x91 - æ
	...
	// 0xB3 - │ (box drawing light vertical)
	...
	// 0xBA - ║ (box drawing double vertical)
	...
	// 0xC4 - ─ (box drawing light horizontal)
	...
	// 0xCD - ═ (box drawing double horizontal)
	...
	{0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0xD8, 0xD8, 0xD8, 0x70, 0x00, 0x00},
	// 0xF6 - ÷
	...
	// 0xFF - nbsp (non-breaking space, drawn as space)
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
}
